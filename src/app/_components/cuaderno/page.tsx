    ...
    return <>
        <div className='container mx-auto'>
            ...
            <div className='grid md:grid-cols-2'>
                <div className='my-5' >
                    <div className=''>
                        <img src="/imgs/single-post-1-img-2-1.jpg.png" className='w-[400px] md:w-[588px] h-[300px] mx-auto rounded-[5px]' alt="" />
                    </div>
                ...
                <div>
                    <div className='grid grid-cols-2 items-center mt-1'>
                        <div className='my-5'>
                            <img src="/imgs/Link.png" alt="" className=" w-[200px] md:w-[282px]  h-[230px] mx-auto rounded-[5px]" />
                        </div>
                    ...
                    <div className='grid grid-cols-2 items-center mt-1'>
                        <div className=''>
                            <img src="/imgs/Figure (2).png" alt="" className=" w-[200px] md:w-[282px]  h-[230px] mx-auto rounded-[5px]" />
                        </div>
                        <div className='text-center md:px-15 h-[190px]'>
                            <h2 className='inter text-[21px] font-[400]' >Egypt</h2>
