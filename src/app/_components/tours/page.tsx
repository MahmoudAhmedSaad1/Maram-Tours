            ...
            <div className='grid md:grid-cols-2 gap-1 md:items-center'>
                <div className='ms-7 lg:ms-40 '>
                    <div className="main-img relative">
                        <img className='w-[325.4px] md:w-[434.1px] rounded-bl-[31.59px] rounded-tr-[31.59px] rounded-br-[31.59px] z-50' src="/imgs/Figure.png" alt="Tours image" />
                        <img className='absolute top-0 left-3.5 z-30' src="/imgs/div.about-two__logo.png" alt="" />
                        <img className='absolute top-[241px] left-[239px] w-[159.2px] md:w-[212.4px] md:-left-[104px] md:top-[275px] border-[5px] border-white rounded-[18.95px] z-30' src="/imgs/Link → image-21.jpg.png" alt="" />
                        <img className='hidden md:block absolute -z-10 -top-10 -left-30' src="/imgs/Section → Section.png" alt="" />
                    </div>
                </div>
